...
public interface SubscriptionRegistry<T, U> {
    NetworkTransport<U> register(String id, T subscriptionRequest, Function<U, Future<String>> requestSerializer, BiConsumer<U, String> responseHandler, RemovalListener<String, U> removalListener, Vertx vertx);
